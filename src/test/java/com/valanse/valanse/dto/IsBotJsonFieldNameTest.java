...
import com.valanse.valanse.dto.Vote.TrendingVoteItemResponse;
...
class IsBotJsonFieldNameTest {
    ...
    @Test
    void TrendingVoteItemResponse는_isBot으로_직렬화된다() throws Exception {
        assertIsBot(TrendingVoteItemResponse.builder().voteId(1L).isBot(true).build(), true);
        assertIsBot(TrendingVoteItemResponse.builder().voteId(1L).isBot(false).build(), false);
    }
